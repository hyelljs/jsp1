...
-->
<%
	MyUser vo = new MyUser("사나",23,"서울");	//setAttribute에서 attr1은 애트리뷰트Key, vo는 애트리뷰트값
	int value1 = 23;						//애트리뷰트 중복괻 키 사용하면 값은 덮어쓰기(변경)
	String value2 = "Hello";
	...
	//요청을 변경하는게 아니고 요청을 전달(forward)합니다. -> 요청이 발생할때의 request 객체 정보를 똑깥이 사용할 수 있게 합니다.
