...
<body>
<!-- 이 jsp 파일의 역할 : 사용자가 서버에게 전송한 데이터를 입력하도록 합니다. -->
<h3>Request Parameter 연습</h3>
<h5>::데이터를 사용자가 입력하고 서버에 전송합니다</h5>
<hr>
<!-- Request Method 확인해보세요. - ?? -->
<h5>Request Method 를 GET 으로 실행합니다.(method 기본값은 get)</h5>
...
POST : 입력데이털를 form data 로 전달. 문자인코딩은 꼭 설정 해줘야한다. 새로운 데이터의 저장 목적으로 사용한다.
-->
</body>
</html>